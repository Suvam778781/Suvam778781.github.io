        ...
        >
          ...
          >
            <Image
              ...
              m="auto"
              src="https://camo.githubusercontent.com/0027f715d14d3818ec06c2e5d8d0b25b3ed3e206a548bc3288052f18d49b0c1e/68747470733a2f2f692e6962622e636f2f5776714c4d6a512f323032332d30332d30312d312e706e67"
              alt="tripoto"
            />
          </Box>
          ...
          >
            ...
            <li>
              User Login page, Signup page, and Admin Login page with form validation.
            </li>
            <li>
            ...
            <li>
              Admin dashboard to view orders, admin also Add, Delete, update products.
            </li>
            <li>
             Search by category, Filter functionality.
            </li>
            <h2>
              Tech stack- React | Redux | Chakra UI | MongoDB | MongoDB Atlas |
              Node JS | Express | AOS Animation
            </h2>
            <Box margin={"auto"} textAlign="center" mt="10px">
              <Link
                href="https://rakiacom.netlify.app/"
                target={"_blank"}
                fontSize={{ base: "0.8em" }}
                w="90px"
                h="70px"
              ...
              <Link
                // as={"Link"}
                href="https://github.com/Suvam778781/Rakia"
                target={"_blank"}
                fontSize={{ base: "0.8em" }}
                w="90px"
                h="70px"
      ...
      <div className="project_box">
        ...
        >
          ...
          <Box
            ...
            margin="auto"
          >
            <Text fontWeight={"semibold"}  color fontSize="25px" my="5px" textAlign={"center"}>
              Industrybuying.com
            </Text>
            <Text fontSize={"13px"} lineHeight="14px" w="90%" m="auto">
